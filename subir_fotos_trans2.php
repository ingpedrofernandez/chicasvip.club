...
echo "<center><h2>Subir Fotos TravestisVip</h2></center>";
?>
<br>

<?php
$dirPath = "../chicasvip.club/uploads2/$code";
...
if (!file_exists($dirPath)) {
    ...
    if (file_exists("../chicasvip.club/uploads2/$code/" . $_FILES["file"]["name"]))
      {
      ...
      "../chicasvip.club/uploads2/$code/" . $_FILES["file"]["name"]);
      echo "Guardado en : " . "../chicasvip.club/uploads2/$code/" . $_FILES["file"]["name"];
      }
