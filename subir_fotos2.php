...
if (!file_exists($dirPath)) {
    ...
    if (file_exists("../chicasvip.club/uploads/$code/" . $_FILES["file"]["name"]))
      {
      ...
      "../chicasvip.club/uploads/$code/" . $_FILES["file"]["name"]);
      echo "Guardado en : " . "../chicasvip.club/uploads/$code/" . $_FILES["file"]["name"];
      }
