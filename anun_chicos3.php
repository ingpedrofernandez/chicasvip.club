...
$juegos=$_POST["juegos"];
$cons=$_POST["cons"];
$sexserv=$frana.$d.$anal.$d.$d.besos.$d.$duplex.$d.$masajes.$d.$strip.$d.$atencion.$d.$despe.$d.$sado.$d.$juegos.$d.$cons;
...
mysql_query("UPDATE men SET phone='$phone', website='$website',hair='$hair',height='$height',weight='$weight',zone='$zone',sche='$horast',place='$lugar',sexserv='$sexserv',serv='$serv',orient='$orient',age='$age',country='$country',lang='$lang',fees1='$feesm',fees2='$feesh',fees3='$feess',payment='$payment',message='$message',complete='$comp' where code='$code'",$link) or die ("Problemas con la modificacion");

echo "<h5>Sus datos han sido completados en nuestra Base de Datos.Puede continuar subiendo sus fotos o salir del sistema y subirlas despues en la opcion del menu CHICAS - SUBIR FOTOS.</h5>";
?>

<FORM ACTION="subir_fotos_chicos.php" method="POST">
<input type="hidden" name="clave" value="<?php echo $clave ?>">
<input type="hidden" name="code" value="<?php echo $code ?>">
<INPUT TYPE="submit" NAME="accion" VALUE="SUBIR FOTOS"><br><br>
</FORM><br><br>

<FORM ACTION="modulofin4.php" method="POST">
