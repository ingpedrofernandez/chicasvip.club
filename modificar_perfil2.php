...
$consulta=mysql_query("select * from women",$link) or die ("Problemas con la consulta");
...
$consulta=mysql_query("select * from women where code='$code'",$link) or die ("Problemas con la consulta");
...
<CENTER><H2>FORMULARIO PARA CHICASVIP INDEPENDIENTES</H2></CENTER>
<?php 
...
<FORM ACTION="modificar_perfil3.php" method="POST">
...
<tr><td><H5>Antiguo Pecho : </H5></td><td><?php echo "<h5>$breast</h5>" ?></td>
</tr>
...
?>
    ...
    <div id="footer">
    <center> Copyright © 2014 |  Diseñado por <a title="INGENIERO EN INFORMATICA PEDRO FERNANDEZ" href="http://www.ingpedrofernandez.site11.com/" target="_parent">INGENIERO EN INFORMATICA PEDRO FERNANDEZ</a></center>
    </div>
