...
$consulta=mysql_query("select * from trans",$link) or die ("Problemas con la consulta");
...
$consulta=mysql_query("select * from trans where code='$code' and complete='no'",$link) or die ("Problemas con la consulta");

if ($reg=mysql_fetch_array($consulta))
{


$consulta=mysql_query("select * from trans where code='$code'",$link) or die ("Problemas con la consulta");
$name=$reg["name"];
$email=$reg["email"];
$city=$reg["city"];
$code=$reg["code"];
...
<br /><br /><br />
<CENTER><H2>FORMULARIO PARA TRAVESTIS INDEPENDIENTES</H2></CENTER>
<?php 
...
<FORM ACTION="anun_trans3.php" method="POST">
