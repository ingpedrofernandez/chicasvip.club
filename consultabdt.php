...
<?php
echo "<center><h2>Consulta de TRAVESTISVIP Anunciadas</h2></center>";
...
//} // end while
$consulta=mysql_query("select * from trans LIMIT $offset, $rowsperpage",$link) or die ("Problemas con la consulta");
?>
<font color=#d82b82>
<?php
