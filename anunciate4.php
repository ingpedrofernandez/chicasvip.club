...
mysql_query("UPDATE women SET phone='$phone', website='$website',hair='$hair',height='$height',weight='$weight',breast='$breast',zone='$zone',sche='$horast',place='$lugar',sexserv='$sexserv',serv='$serv',orient='$orient',age='$age',country='$country',lang='$lang',fees1='$feesm',fees2='$feesh',fees3='$feess',payment='$payment',message='$message',complete='$comp' where password='$clave'",$link) or die ("Problemas con la modificacion");
...
<FORM ACTION="subir_fotos.php" method="POST">
