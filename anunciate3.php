...
echo "<h5>Sus datos han sido completados en nuestra Base de Datos.Puede continuar subiendo sus fotos o salir del sistema y subirlas despues en la opcion del menu ANUNCIATE - CARGAR FOTOS.</h5>";
?>
