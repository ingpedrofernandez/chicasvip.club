...
$consulta=mysql_query("select * from trans where code='$code3'",$link) or die ("Problemas con la consulta");
...
<FORM ACTION="camclat3.php" method="POST">
<input type=hidden name=todo value=submit-form>
<H5>CAMBIO DE CLAVE TRAVESTIS VIP</H5><br />
<center><table><tr>
