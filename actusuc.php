...
<?php
echo "<center><h2>Consulta de Actividad de Usuarios Completa</h2></center>";
...
//} // end while
$consulta=mysql_query("select * from users LIMIT $offset, $rowsperpage",$link) or die ("Problemas con la consulta");
?>
<font color=#d82b82>
<?php
echo "<center><table border=1 BORDERCOLOR=#d82b82></center>";
echo "<th>Usuario</th><th>Fecha y Hora Log in</th><th>Fecha Y Hora Log out</th><th>Tiempo en el sistema</th>";
...
echo "<td>".$reg['date_time2']."</td>";
echo "<td>".$reg['elapsed_time']."</td>";
echo "</tr>";
//echo "</table>";
}
echo "</table>";
