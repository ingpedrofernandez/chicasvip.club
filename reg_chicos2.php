...
$text="Hola ";
$dot=".";
$text1=" Su registro ha sido exitoso.";

$message=$text.$name.$dot.$text1;
?>
...
$consulta=mysql_query("select * from men order by code desc limit 1",$link) or die ("Problemas con la consulta");
...
$consulta =mysql_query("SELECT COUNT(*) AS COUNT FROM men",$link) or die ("Problemas con la consulta");
...
mysql_query("insert into men (password,name,email,city,code) values ('$pw2','$name','$email','$city','$codigo1')",$link) or die ("Problemas con la grabacion");

mysql_query("UPDATE men SET complete='$comp' where password='$pw2'",$link) or die ("Problemas con la modificacion");
