...
<?php
echo "<center><h2>Consulta de CHICOSVIP Anunciados</h2></center>";
...
//} // end while
$consulta=mysql_query("select * from men LIMIT $offset, $rowsperpage",$link) or die ("Problemas con la consulta");
?>
<font color=#d82b82>
<?php
...
echo "<th>Página Web</th><th>Color de Pelo</th><th>Altura</th><th>Peso</th><th>Horario</th>";
echo "</tr>";
echo "<tr>";
...
echo "<th>Lugar</th><th>Servicios Sexuales</th><th>Servicios</th><th>Orientación</th><th>Edad</th><th>País</th>";
echo "</tr>";
echo "<tr>";
...
echo "<th>Idiomas</th><th>Tarifa 1/2 Hora</th><th>Tarifa 1 Hora</th><th>Tarifa Salidas</th><th>Forma de Pago</th><th>Mensaje</th>";
echo "</tr>";
echo "<tr>";
