...
$consulta=mysql_query("select * from trans order by code desc limit 1",$link) or die ("Problemas con la consulta");
...
$consulta =mysql_query("SELECT COUNT(*) AS COUNT FROM trans",$link) or die ("Problemas con la consulta");
...
mysql_query("insert into trans (password,name,email,city,code) values ('$pw2','$name','$email','$city','$codigo1')",$link) or die ("Problemas con la grabacion");

mysql_query("UPDATE trans


 SET complete='$comp' where password='$pw2'",$link) or die ("Problemas con la modificacion");
